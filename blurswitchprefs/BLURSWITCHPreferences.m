#include "BLURSWITCHPreferences.h"
#import <AudioToolbox/AudioServices.h>

@implementation BLURSWITCHPreferencesListController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        BLURSWITCHAppearanceSettings *appearanceSettings = [[BLURSWITCHAppearanceSettings alloc] init];
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/blurswitchprefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/blurswitchprefs.bundle/banner.png"];
...
@implementation BLURSWITCHAppearanceSettings: HBAppearanceSettings
